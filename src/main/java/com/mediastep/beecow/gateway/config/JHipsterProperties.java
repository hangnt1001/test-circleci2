...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "beecowGateway@localhost";
    ...
    public static class Security {
        ...
        public static class Authentication {
            ...
            public static class Jwt {
                ...
                private long tokenValidityInSeconds = 2592000; // 1 month

                private long tokenValidityInSecondsForRememberMe = 31536000; // 1 year
    ...
    public static class Swagger {
        ...
        private String title = "beecowGateway API";

        private String description = "beecowGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "beecowGateway";
