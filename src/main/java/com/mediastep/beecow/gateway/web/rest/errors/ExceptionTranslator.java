...
public class ExceptionTranslator {
    ...
    @ResponseBody
    public UserNotActivatedException.ErrorVM processConcurencyError(UserNotActivatedException ex) {
    ...
    /*
     * NOTE: All exception is handled by CommonExceptionTranslator
     *
