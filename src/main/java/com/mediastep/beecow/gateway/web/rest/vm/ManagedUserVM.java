...
public class ManagedUserVM extends UserDTO {
    ...
    public ManagedUserVM(User user) {
        super(user.getLogin(), user.getFirstName(), user.getLastName(), user.getEmail(),
        user.getActivated(), user.getLangKey(), Authority.authoritiesToStrings(user.getAuthorities()));
        this.id = user.getId();
